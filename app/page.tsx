...
const processSteps = [
  {
    title: "Découverte",
    detail: "Ateliers, benchmark et définition de votre vision produit.",
  },
  {
    title: "Conception",
    detail: "UX/UI, prototypage et tests utilisateurs pour valider rapidement.",
  },
  {
    title: "Build & scale",
    detail: "Développement agile, QA rigoureux et mise en production continue.",
  },
];
...
const testimonials = [
  {
    quote:
      "Une équipe réactive qui a compris nos enjeux business dès la première semaine.",
    author: "Sarah M. · CEO, StartUp Studio",
  },
  {
    quote:
      "Notre trafic a doublé après la refonte. Le design est moderne et les performances sont au rendez-vous.",
    author: "Amine B. · Head of Growth",
  },
];
    ...
    <>
      ...
      <main>
        <section className="hero container">
          <div>
            ...
            <div className="hero-meta">
              <div>
                <strong>Consulting + delivery</strong>
                <span>Des équipes dédiées à votre croissance.</span>
              </div>
              <div>
                <strong>Basé à Paris</strong>
                <span>Interventions en Europe et Afrique.</span>
              </div>
            </div>
          </div>
        ...
        <section className="section process">
          <div className="container">
            <h2>Une méthode claire, des résultats rapides</h2>
            <p>
              Notre approche combine stratégie, design et technologie pour réduire les
              délais de lancement et maximiser l'impact.
            </p>
            <div className="grid">
        ...
        <section className="section testimonials">
          <div className="container">
            ...
            <p>
              Nos clients apprécient notre rigueur, notre transparence et la qualité de
              nos livrables.
            </p>
            <div className="grid">
              {testimonials.map((testimonial) => (
                <article key={testimonial.author} className="card testimonial-card">
          ...
          <div className="container">
            ...
            <div className="cta">
              <div>
                <h3>Un brief prêt ?</h3>
                <p>
                  Programmez un call de 30 minutes pour cadrer votre roadmap digitale.
                </p>
              </div>
              <a className="button primary" href="mailto:contact@danhabibtech.cc">
                Réserver un appel
              </a>
            </div>
          </div>
